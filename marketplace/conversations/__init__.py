...
# SEARCH_KEY: MARKETPLACE_CONVERSATIONS_CONFIG
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        container = get_container('marketplace_conversations')
        ...
        for conv in conversations:
            try:
                ...
                if other_user_id:
                    ...
                    user_query = "SELECT c.name, c.avatar FROM c WHERE c.id = @id"
                    user_params = [{"name": "@id", "value": other_user_id}]
                    ...
                    if users:
                        other_user = {
                            "name": users[0].get('name', 'Unknown User'),
                ...
                if 'plantId' in conv:
                    ...
                    if plants:
                        plant_info = {
                            "name": plants[0].get('title', 'Plant Discussion')
                        }
